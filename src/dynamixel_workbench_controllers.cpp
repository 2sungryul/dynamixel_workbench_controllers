...
{   
  ...
  if (is_cmd_vel_topic_ == true)
  {
    ...
    this->declare_parameter("mobile_robot_config/seperation_between_wheels",0.160);
  ...
  std::string yaml_file = "/home/ncslab/ros2_ws/src/dynamixel_workbench_controllers/config/basic.yaml";
